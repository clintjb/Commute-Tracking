...
# Heatmap
pivot = df.groupby(["Period", "Day of Week"]) ["Duration (mins)"].mean().unstack("Day of Week")

# Ensure consistent ordering and avoid Series edge cases
pivot = pivot.reindex(index=PERIOD_ORDER, columns=WEEKDAYS)
